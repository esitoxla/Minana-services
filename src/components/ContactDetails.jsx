      ...
      <div className="px-4 py-10 md:px-8 lg:px-16">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <form className="flex flex-col gap-6 w-full lg:w-1/2">
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="bg-white w-full sm:w-1/2 h-[50px] px-4 rounded outline-none"
              />
              <input
                type="email"
            ...
            <textarea
              ...
              className="bg-white h-[9rem] px-4 py-4 rounded outline-none w-full"
            />
            <button
          ...
          <div className="flex flex-col gap-6 w-full lg:w-1/2">
            ...
            <div className="h-[200px] md:h-[9rem] w-full rounded overflow-hidden shadow-lg">
              <iframe
